...
import Logo from "../Asserts/logo2.jpg";
//css
// import "./admin.css";
...
function ResponsiveDrawer(props) {
  ...
  const handlelogout = () => {
    localStorage.removeItem("stafflogintoken");
      ...
      <List>
        ...
        >
          <ListItemText className="text-center">
            ...
            <h3 className="username" style={{ padding: "15px" }}>
              {/* {values.googleData.name} */}
              <span className="headving"> Staff Panel</span>
            </h3>
          </ListItemText>
        </ListItem>
        <Link to="/staffOrder">
          ...
          >
            ...
            >
              <RiStore2Line size={24} color="black" />{" "}
            </ListItemIcon>
            <ListItemText
              style={{
                width: "76px",
